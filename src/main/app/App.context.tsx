...
import { IProject, TTabValue } from './App.model';
...
export function AppProvider({ children }: any) {
  ...
  const [selectedTab, setSelectedTab] = useState<TTabValue>('overview');
  ...
  const value = useMemo(
    ...
    [loadingMessages, errorMessages, selectedTab, projects, currentProject]
  );
